...
function normalizeOptions(o) {
  ...
  /* Variant stock is authoritative whenever this product has options. Keep
     it through every normalisation/update cycle instead of collapsing it to
     the legacy single qtyOnHand field. */
