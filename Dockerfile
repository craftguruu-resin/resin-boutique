...
# build-generated cache-busting query string is preserved. Match the asset
# path, not an old hard-coded version, because the build step changes ?v=.
RUN sed -i 's#</head>#<link rel="stylesheet" href="hero-final.css?v=20260908a" /><link rel="stylesheet" href="home-shop-category-final.css?v=20260915a" /></head>#' index.html raw-material-shop.html \
